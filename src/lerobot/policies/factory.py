...
def make_pre_post_processors(
    ...
    **kwargs: Unpack[ProcessorConfigKwargs],
    ...
    elif isinstance(policy_cfg, ACTMultiFrameConfig):
        from lerobot.policies.act_multiframe.processor_act_multiframe import make_act_multiframe_pre_post_processors

        processors = make_act_multiframe_pre_post_processors(
            config=policy_cfg,
            dataset_stats=kwargs.get("dataset_stats"),
        )
